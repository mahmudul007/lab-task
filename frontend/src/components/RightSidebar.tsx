const RightSidebar = () => {
  const friends = [
    { img: '/images/people1.png', name: 'Steve Jobs', role: 'CEO of Apple', online: false, time: '5 minute ago' },
    { img: '/images/people2.png', name: 'Ryan Roslansky', role: 'CEO of Linkedin', online: true },
    { img: '/images/people3.png', name: 'Dylan Field', role: 'CEO of Figma', online: true },
    { img: '/images/people1.png', name: 'Steve Jobs', role: 'CEO of Apple', online: false, time: '5 minute ago' },
    { img: '/images/people2.png', name: 'Ryan Roslansky', role: 'CEO of Linkedin', online: true },
    { img: '/images/people3.png', name: 'Dylan Field', role: 'CEO of Figma', online: true },
    { img: '/images/people1.png', name: 'Steve Jobs', role: 'CEO of Apple', online: false, time: '5 minute ago' },
        ...
        <div className="_feed_right_inner_area_card _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          ...
          <div className="_feed_bottom_fixed">
            {friends.map((friend, i) => (
              <div
                key={i}
                className={`_feed_right_inner_area_card_ppl${!friend.online && friend.time ? ' _feed_right_inner_area_card_ppl_inactive' : ''}`}
              >
